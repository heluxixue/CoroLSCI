# NOTE (2026-09-12): the boundary-perturbation section of this script used a
# SINGLE fixed mm/px value for all sessions; the per-session-calibration
# reanalysis lives in compute_review4.py, which supersedes those numbers.
# -*- coding: utf-8 -*-
