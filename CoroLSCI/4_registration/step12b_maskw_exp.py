"""step12b_maskw_exp.py -- Soft-mask weighted DIS registration (adopted)

Multiplies the DIS input by a coronary soft mask (Gaussian-blurred
prediction; sigma=2 adopted after the innovation sweep) so the flow is
driven by coronary structure. This is the adopted registration method
of the paper.
"""
