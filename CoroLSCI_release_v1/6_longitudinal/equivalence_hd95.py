"""equivalence_hd95.py -- reviewer-recommended robustness analyses

1) Area net change via two-stage block-summary bootstrap (90% CI for the
   TOST equivalence test)
2) Fresh 20-frame three-way set: HD95 (algorithm vs both experts; between
   experts) + thin/thick vessel stratified Dice
Output: equivalence_hd95.json
"""
import csv
import json
import os
