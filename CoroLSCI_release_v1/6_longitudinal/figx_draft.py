...
axA.plot(min_h1, perf_pct, "o-", color=BLUE, lw=2, ms=6,
         label="Perfusion $P$ (mfr)")
axA.plot(min_h1, area_pct, "s-", color=ORANGE, lw=2, ms=6,
         label="Vessel area $A$")
axA.annotate("$-22.0\\%$ (95% CI 20.7–23.8%)", (min_h1[5], perf_pct[5]),
...
axA.set_xlabel("Perfusion time from T2 (min)", fontsize=10)
